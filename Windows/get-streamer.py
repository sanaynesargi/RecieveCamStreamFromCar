...
os.system(r"SET PATH=C:\msys64\mingw64\bin;C:\msys64\usr\bin;%PATH%")
os.system(r"SET PKG_CONFIG_PATH=C:\msys64\mingw64\lib\pkgconfig")
os.system(r"SET XDG_DATA_DIRS=C:\msys64\mingw64\share")